...
@section('content')
@section('title','Gestion des fichiers des étudiants')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @lang('lang.text_alert_title_file')<br>{{$fileManager->title}}
            </div>
...
<div class="col-xl-8 mx-auto">
    <a href="{{route('fileManager.index')}}" class="btn btn-outline-info btn-sm">← @lang('lang.text_back_file')</a>
</div>
<div class="d-flex flex-column align-items-center h-100 justify-content-between border border-secondary p-5 mt-3 mb-5 rounded-lg">
    ...
    <div class="mt-4 d-flex gap-3 justify-content-center p-5 m-5">
        <a href="{{route('fileManager.edit', $fileManager->id)}}" class="btn btn-primary">@lang('lang.text_update')</a>
