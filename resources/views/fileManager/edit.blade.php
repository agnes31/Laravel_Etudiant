...
@section('content')
@section('title', 'Enregistrement des fichiers')
    ...
    <div class="card mb-5 mx-auto bg-gradient-danger flex-grow-1 d-flex flex-column">
        <form method="post" class="d-flex flex-column flex-grow-1">
            ...
            <div class="card-header text-center text-warning">
                <h1 class="display-5 bg-gradient-danger text-white">@lang('lang.text_modif_file')</h1>
            </div>
            <div class="card-body">
                <nav>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-en" role="tabpanel" aria-labelledby="nav-en-tab" tabindex="0">
                        <div class="control-group col-12">
                            ...
                            <input type="text" id="title" name="title" class="form-control" value="{{$fileManager->title}}" required>
                            @if($errors->has('title'))
                    ...
                    <div class="tab-pane fade" id="nav-fr" role="tabpanel" aria-labelledby="nav-fr-tab" tabindex="0">
                        <div class="control-group col-12">
                            ...
                            <input type="text" id="title_fr" name="title_fr" class="form-control" value="{{$fileManager->title_fr}}">
